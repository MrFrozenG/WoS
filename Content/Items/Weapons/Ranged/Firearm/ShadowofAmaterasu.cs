...
public class ShadowofAmaterasu : ModItem
{
    public override void SetDefaults()
	{
		...
		Item.useTime = 13;
		Item.GetGlobalItem<ItemsUtilsGlow>().glowTexture = ModContent.Request<Texture2D>("WoS/Content/Items/Weapons/Ranged/Firearm/ShadowofAmaterasu_glow").Value;
		Item.autoReuse = true;
	...
	{
		if (type == ProjectileID.Bullet) type = ModContent.ProjectileType<MoltenBulletS>();
