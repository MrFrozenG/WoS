...
namespace WoS.Content.Items.Weapons.Ranged
{
	...
	{		
		public override void SetDefaults()
		{
			...
			Item.useTime = 13;
			Item.GetGlobalItem<ItemUseGlow>().glowTexture = ModContent.Request<Texture2D>("WoS/Content/Items/Weapons/Ranged/ShadowofBoreas_glow").Value;
			Item.autoReuse = true;
		...
		{
			if (type == ProjectileID.Bullet) type = ModContent.ProjectileType<FrostBulletShot>();
