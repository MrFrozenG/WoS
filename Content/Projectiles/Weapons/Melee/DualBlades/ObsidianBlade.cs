...
namespace WoS.Content.Projectiles.Weapons.Melee.DualBlades
{
    public class ObsidianBlade : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.GetGlobalProjectile<ProjectileUtilsGlow>().glowTexture = ModContent.Request<Texture2D>("WoS/Content/Projectiles/Weapons/Melee/DualBlades/ObsidianBlade_glow").Value;
        }
        private int count;
        private bool HasHit;
