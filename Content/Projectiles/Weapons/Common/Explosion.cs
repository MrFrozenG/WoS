...
namespace WoS.Content.Projectiles.Weapons.Common
{
    public class Explosion : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.GetGlobalProjectile<ProjectileUtilsGlow>().glowTexture = ModContent.Request<Texture2D>("WoS/Content/Projectiles/Weapons/Common/Explosion_Glow").Value;
        }
