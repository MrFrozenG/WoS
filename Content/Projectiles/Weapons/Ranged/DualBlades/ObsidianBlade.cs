...
{
    public class ObsidianBlade : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.GetGlobalProjectile<ProjectileUtilsGlow>().glowTexture = ModContent.Request<Texture2D>("WoS/Content/Projectiles/Weapons/Ranged/DualBlades/ObsidianBlade_glow").Value;
        }
        private int count;
        private bool HasHit;
        ...
        private void Return()
        {
            ...
            if (Vector2.Distance(Projectile.Center, player.Center) < 16f)
            {
                Projectile.Kill();
            }
        }
