...
namespace WoS.Content.Projectiles.Weapons.Ranged.DualBlades
{
    public class MoltenBlade : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.GetGlobalProjectile<ProjectileUtilsGlow>().glowTexture = ModContent.Request<Texture2D>("WoS/Content/Projectiles/Weapons/Ranged/DualBlades/MoltenBlade_glow").Value;
        }
        private int count;
        private bool HasHit;
