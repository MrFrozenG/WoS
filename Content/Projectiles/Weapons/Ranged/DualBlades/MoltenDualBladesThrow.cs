...
namespace WoS.Content.Projectiles.Weapons.Ranged.DualBlades
{
    public class MoltenDualBladesThrow : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.GetGlobalProjectile<ProjectileUtilsGlow>().glowTexture = ModContent.Request<Texture2D>("WoS/Content/Projectiles/Weapons/Ranged/DualBlades/MoltenDualBladesThrow_glow").Value;
        }
        private int count;
        private int hits;
